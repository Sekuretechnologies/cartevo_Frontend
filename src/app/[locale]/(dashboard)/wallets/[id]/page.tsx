...
// 								<Title
// 									title={t.wallets.detail.informationTitle}
// 								/>
// 								<BadgeLabel
// 									className="text-xs"
// 									label={
...
// 										</div>
// 									</div>
// 									<div className="mt-3 flex flex-col items-end gap-2  w-2/4 ">
// 										<CButton
...
// 											{showSendPopover && (
// 												<div
// 													className="absolute right-0 -bottom-12 translate-y-1/2 mt-5 w-64 origin-top-right bg-white rounded-lg shadow-lg ring-1 ring-black/5 p-2 z-[100] animate-[fadeZoom_160ms_ease-out]"
// 													style={{
// 														animationName:
// 															"fadeZoom",
// 														animationDuration:
...
// 								<div className="mb-5">
// 									<Title
// 										title={t.wallets.detail.trxHistoryTitle}
// 									/>
...
// 								text={
// 									isSavingPhone
// 										? t.wallets.modals.phones.saving
// 										: t.wallets.modals.phones.save
// 								}
// 								btnStyle="blue"
...
// 								text={
// 									isUpdatingPhone
// 										? t.wallets.modals.phones.editSaving
// 										: t.wallets.modals.phones.editSave
// 								}
// 								btnStyle="blue"
// 								onClick={async () => {
// 									if (!selectedPhone?.id) return;
...
export default function WalletDetailsPage() {
	...
	const handleFundWallet = async (
		...
		setIsFunding(true);
		try {
			// Rafraîchir les données avant la transaction
			await walletQuery.refetch();
			await walletTrxQuery.refetch();
			...
			// Rafraîchir les données après la transaction, qu'elle réussisse ou échoue
			await walletQuery.refetch();
			await walletTrxQuery.refetch();
			setIsFunding(false);
		}
					...
					return (
						<div className="bg-white rounded-lg p-6 w-[400px] relative">
							<h2 className="text-xl font-bold mb-4">
								PayIn{" "}
								{
									<ArrowRight className="inline-block  mx-2 -mt-1.5" />
								}{" "}
								PayOut
							</h2>
							<div className="space-y-4">
